        ...
        <div className="md:flex md:items-end md:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg leading-relaxed text-gray-700">
              Discover how RescueHome has helped individuals like you create
              stunning portfolios with ease. See why our users love the
              simplicity and flexibility of our platform.
            </p>
          </div>
          <a
            href="#"
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div>
                ...
                <div className="mt-4">
                  <p className="text-2xl font-bold text-[#003B95] sm:text-3xl">
                    {testimonial.title}
                  </p>
